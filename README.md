# AW_Criteria_ML_Cloud-OnPremise
...
- branch <i>AW_Criteria-ML&Cloud_Procedimentos</i>: procedimentos criados e usados para provisionamento das instâncias de RStudio nos provedores de serviço de cloud selecionados para o estudo.

- branch <i>AW_Criteria-ML&Cloud_Scripts</i>: scripts criados para testar os diversos cenários nos ambientes selecionados. Os scripts estão no formato R Script ou R Markdown. Mais detalhes sobre os scripts podem ser vistos no README do branch.

- branch <i>AW_Criteria-ML&Cloud_ENEM2020</i>: resultados das execuções dos scripts criados em R Markdown, no formato HTML.
